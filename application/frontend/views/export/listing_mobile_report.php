                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-6 col-xs-6">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-gamepad"></i></span>
                            <?php
                            $kpi_export_type = $this->session->userdata('kpi_export_type') ;
                            ?>
                            <select class="form-control" name="mobile_kpi_type" id="slTypeSelection">
                                <option value='os' <?php if($kpi_export_type=="os") echo "selected"?>>OS</option>
                                <option value='channel' <?php if($kpi_export_type=="channel") echo "selected"?>>Channel</option>
                                <option value='package' <?php if($kpi_export_type=="package") echo "selected"?>>Package</option>
                            </select>
                        </div>
                    </div>

...
<div class="nav-tabs-custom">
	<ul class="nav nav-tabs" id="package">
	...
	<?php 
		$total = 0;
		$colors = $pie["colors"];
		foreach ($pie["package"] as $key => $value) {
	?>
		<div class="tab-pane <?php if($key == 1) echo "active"?>" id="tab_t<?php echo $key?>">
			<section id="section-package">
				<div class="row">
					<div class="col-md-4">
						<div class="box box-warning">
							...
							<div class="box-footer">
								...
								<?php 
								$total += 1;
								$data = $pie["package"][$key]["a" . $key];
								$viewdata['id'] = "container_a" . $key;
								$viewdata['title'] = "Active User By Package";
								$viewdata['subTitle'] = "";
								$viewdata['data'] = $data;
					...
					<div class="col-md-4">
						<div class="box box-warning">
							...
							<div class="box-footer">
								...
								<?php 
								$total += 1;
								$data = $pie["package"][$key]["pu" . $key];
								$viewdata['id'] = "container_pu" . $key;
								$viewdata['title'] = "Paying User By Package";
								$viewdata['subTitle'] = "";
								$viewdata['data'] = $data;
								$viewdata['colors'] = $colors;
								$html = $this->load->view("body_parts/chart/pie_label", $viewdata, TRUE);
					...
					<div class="col-md-4">
						<div class="box box-warning">
							...
							<div class="box-footer">
								...
								<?php 
								$total += 1;
								$data = $pie["package"][$key]["gr" . $key];
								$viewdata['id'] = "container_gr" . $key;
								$viewdata['title'] = "Revenue By Package";
								$viewdata['subTitle'] = "";
								$viewdata['data'] = $data;
								$viewdata['colors'] = $colors;
								$html = $this->load->view("body_parts/chart/pie_label", $viewdata, TRUE);
					...
					<?php if($pie["package"][$key]["n" . $key] != null) {?>
					<div class="col-md-4">
						<div class="box box-warning">
							<!--<div class="box-header with-border">
                                    <h3 class="box-title"><i class="fa fa-money" name="revenue"></i> Revenue</h3>
							...
							<div class="box-footer">
								...
								<?php 
								$total += 1;
								$data = $pie["package"][$key]["n" . $key];
								$viewdata['id'] = "container_n" . $key;
								$viewdata['title'] = "New User By Package";
								$viewdata['subTitle'] = "";
								$viewdata['data'] = $data;
								$viewdata['colors'] = $colors;
								$html = $this->load->view("body_parts/chart/pie_label", $viewdata, TRUE);
					...
					<!-- /.col -->
					<!-- /.col -->
					<?php if($pie["package"][$key]["npu" . $key] != null) {?>
					<div class="col-md-4">
						<div class="box box-warning">
							<!--<div class="box-header with-border">
                                    <h3 class="box-title"><i class="fa fa-money" name="revenue"></i> Revenue</h3>
							...
							<div class="box-footer">
								...
								<?php 
								$total += 1;
								$data = $pie["package"][$key]["npu" . $key];
								$viewdata['id'] = "container_npu" . $key;
								$viewdata['title'] = "New Paying User By Package";
								$viewdata['subTitle'] = "";
								$viewdata['data'] = $data;
								$viewdata['colors'] = $colors;
								$html = $this->load->view("body_parts/chart/pie_label", $viewdata, TRUE);
					...
					<?php }?>
					<!-- /.col -->
					<?php if($pie["package"][$key]["npu_gr" . $key] != null) {?>
					<div class="col-md-4">
						<div class="box box-warning">
							<!--<div class="box-header with-border">
                                    <h3 class="box-title"><i class="fa fa-money" name="revenue"></i> Revenue</h3>
							...
							<div class="box-footer">
								...
								$viewdata['title'] = "New Paying Revenue By Package";
								$viewdata['subTitle'] = "";
								$viewdata['data'] = $data;
								$viewdata['colors'] = $colors;
								$html = $this->load->view("body_parts/chart/pie_label", $viewdata, TRUE);

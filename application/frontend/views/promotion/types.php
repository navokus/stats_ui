...
<div class="box box-solid bg-green-gradient">
    <div class="box-header">
        <h3 class="box-title">PHÂN LOẠI KHUYẾN MÃI</h3>

    </div>
    <!-- /.box-header -->
    <form name="promotion" action="<?php echo site_url('Promotion/types') ?>" method="post">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    foreach ($aPromotion as $key => $value) {
                        ...
                        echo '
						<li class="' . $active . '">
							<a href="' . site_url('Promotion/types/' . $key) . '" >' . $times . ' ' . $pre_currDate . '</a>
							<button onclick="window.location.href=\'' . site_url('promotion_module/Types/delCache/' . $key) . '\'" class="btn btn-box-tool" data-toggle="tooltip" title="Remove" style="position:absolute; top:-5px; right:0px"><i class="fa fa-times"></i></button>
						</li>';

...
?>
	...
	<div class="col-md-6">
		...
		<div class="box-header with-border">
                <h3 class="box-title" id="exportFileName"><i class="fa fa-th"></i> Top 10 <?php echo $body['type_name']?> by revenue in <?php echo $body['month']?></h3>
                <div class="box-tools">
		 ...
		 <div class="box-body">
			...
			<table id="game-list-table-<?php echo $body['type']?>" class="table table-bordered table-bordered-gray table-striped" class="cell-border"
				...
				<tbody>
                	...
                	<tr >
						<td><?php echo $idx;?></td>
						<td><a href="<?php echo site_url('index.php/dashboard/' + $value['game_code']); ?>"><?php echo $value['game_name'];?></a></td>
						<td><?php switch ($value['game_type']){
							case 1:
								echo "Client Game";
								break;
							case 2:

...
<div class="nav-tabs-custom">
	<?php 
		$total = 0;
		foreach ($pie["group"] as $key => $value) {
			$kpiName = $key; 
			if($key == "17") $kpiName = "w";
			if($key == "31") $kpiName = "m";
			if($key == "4") $kpiName = "1";
	...
	<div class="tab-content">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<?php 
						...
						$viewdata['subTitle'] = $this->util->get_sub_chart_title(array("feature"=>"Active Users", "from"=>$dayArr[1], "game_info"=>$this->_gameInfo), $key);
						$viewdata['kpi'] = "Active User";
						$viewdata['metric'] = "Active User";
						$viewdata['unit'] = "user";
						$viewdata['data'] = $data;
						$viewdata['colors'] = $pie["colors"];
						
						$viewdata['days'] = $dayArr[1];
						$viewdata['selectedGroup'] = $selectedGroup["a" . $kpiName];
						$html = $this->load->view("body_parts/chart/gpie", $viewdata, TRUE);
						echo $html;
					?>
				</div>
				<div class="col-md-6">
					<div id="p_active<?php echo $key ?>" class="chart-area text-center"><i class="fa fa-spinner fa-spin fa-4x"></i></div>
					<?php 
						$total += 1;
						$data = $pie["group"][$key]["a" . $kpiName];
						$dayArr = $pie["log_date"];
						...
						$viewdata['timing'] = $key;
						$viewdata["game"] = $game;
						$viewdata['id'] = "p_active" . $key;
						$viewdata['title'] = $this->util->get_main_chart_title(array("feature"=>"Active Users","game_info"=>$this->_gameInfo), $key);
						$viewdata['subTitle'] = $this->util->get_sub_chart_title(array("feature"=>"Active Users", "from"=>$dayArr[0], "game_info"=>$this->_gameInfo), $key);
						$viewdata['kpi'] = "Active User";
						$viewdata['metric'] = "Active User";
						$viewdata['unit'] = "user";
						$viewdata['data'] = $data;
		...
		<div class="tab-pane" id="tab_ccu<?php echo $key ?>">
			<?php if(count($pie["group"][$key]["acu" . $kpiName]) == 0) {
				$html = $this->load->view("body_parts/contact", null, TRUE);
				echo '<div class="row">' . $html . '</div>';
			} else {
			?>
			<div class="col-md-6">
				...
				<?php 
					$total += 1;
					$data = $pie["group"][$key]["acu" . $kpiName];
					$dayArr = $pie["log_date"];
					...
					$viewdata['subTitle'] = $this->util->get_sub_chart_title(array("feature"=>"ACU", "from"=>$dayArr[1], "game_info"=>$this->_gameInfo), $key);
					$viewdata['kpi'] = "ACU";
					$viewdata['metric'] = "ACU";
					$viewdata['unit'] = "user";
			...
			<div class="col-md-6">
				<div id="p_acu<?php echo $key ?>" class="chart-area"><i class="fa fa-spinner fa-spin fa-4x"></i></div>
				<?php 
					$total += 1;
					$data = $pie["group"][$key]["acu" . $kpiName];
					$dayArr = $pie["log_date"];
					...
					$viewdata["timing"] = $key;
					$viewdata["game"] = $game;
					$viewdata['id'] = "p_acu" . $key;
					$viewdata['title'] = $this->util->get_main_chart_title(array("feature"=>"ACU","game_info"=>$this->_gameInfo), $key);
					$viewdata['subTitle'] = $this->util->get_sub_chart_title(array("feature"=>"ACU", "from"=>$dayArr[0], "game_info"=>$this->_gameInfo), $key);
					$viewdata['kpi'] = "ACU";
					$viewdata['metric'] = "ACU";
					$viewdata['unit'] = "user";
					$viewdata["valueDecimals"] = 2;
			...
			<div class="col-md-6">
				...
				<?php 
					$total += 1;
					$data = $pie["group"][$key]["pcu" . $kpiName];
					$dayArr = $pie["log_date"];
					...
					$viewdata['subTitle'] = $this->util->get_sub_chart_title(array("feature"=>"PCU", "from"=>$dayArr[1], "game_info"=>$this->_gameInfo), $key);
					$viewdata['kpi'] = "PCU";
					$viewdata['metric'] = "PCU";
					$viewdata['unit'] = "user";
					$viewdata['data'] = $data;
			...
			<div class="col-md-6">
				...
				<div id="p_pcu<?php echo $key ?>" class="chart-area"><i class="fa fa-spinner fa-spin fa-4x"></i></div>
				<?php 
					$total += 1;
					$data = $pie["group"][$key]["pcu" . $kpiName];
					$dayArr = $pie["log_date"];
					...
					$viewdata["timing"] = $key;
					$viewdata["game"] = $game;
					$viewdata['id'] = "p_pcu" . $key;
					$viewdata['title'] = $this->util->get_main_chart_title(array("feature"=>"PCU","game_info"=>$this->_gameInfo), $key);
					$viewdata['subTitle'] = $this->util->get_sub_chart_title(array("feature"=>"PCU", "from"=>$dayArr[0], "game_info"=>$this->_gameInfo), $key);
					$viewdata['kpi'] = "PCU";
					$viewdata['metric'] = "PCU";
					$viewdata['unit'] = "user";
					$viewdata['data'] = $data;
		...
		<div class="tab-pane" id="tab_accregister<?php echo $key ?>">
			<div class="col-md-6">
				...
				<?php 
					...
					$viewdata['subTitle'] = $this->util->get_sub_chart_title(array("feature"=>"Account Register", "from"=>$dayArr[1], "game_info"=>$this->_gameInfo), $key);
			...
			<div class="col-md-6">
				<div id="p_accregister<?php echo $key ?>" class="chart-area"><i class="fa fa-spinner fa-spin fa-4x"></i></div>
				<?php 
					$total += 1;
					$data = $pie["group"][$key]["n" . $kpiName];
					$dayArr = $pie["log_date"];
					...
					$viewdata["timing"] = $key;
					$viewdata["game"] = $game;
					$viewdata['id'] = "p_accregister" . $key;
					$viewdata['title'] = $this->util->get_main_chart_title(array("feature"=>"Acccount Register","game_info"=>$this->_gameInfo), $key);
					$viewdata['subTitle'] = $this->util->get_sub_chart_title(array("feature"=>"Account Register", "from"=>$dayArr[0], "game_info"=>$this->_gameInfo), $key);
					$viewdata['kpi'] = "Account Register";
					$viewdata['metric'] = "Account Register";
					$viewdata['unit'] = "user";
					$viewdata['data'] = $data;
		...
		<div class="tab-pane" id="tab_revenue<?php echo $key ?>">
			<div class="col-md-6">
				...
				<?php if(count($pie["group"][$key]["pu" . $kpiName]) == 0) {
					$html = $this->load->view("body_parts/contact", null, TRUE);
					echo '<div class="row">' . $html . '</div>';
				} else {
				?>
				...
				<?php 
					...
					$viewdata['subTitle'] = $this->util->get_sub_chart_title(array("feature"=>"Paying User", "from"=>$dayArr[1], "game_info"=>$this->_gameInfo), $key);
			...
			<div class="col-md-6">
				...
				?>
				<div id="p_paying<?php echo $key ?>" class="chart-area"><i class="fa fa-spinner fa-spin fa-4x"></i></div>
				<?php 
					$total += 1;
					$data = $pie["group"][$key]["pu" . $kpiName];
					$dayArr = $pie["log_date"];
					...
					$viewdata["timing"] = $key;
					$viewdata["game"] = $game;
					$viewdata['id'] = "p_paying" . $key;
					$viewdata['title'] = $this->util->get_main_chart_title(array("feature"=>"Paying User","game_info"=>$this->_gameInfo), $key);
					$viewdata['subTitle'] = $this->util->get_sub_chart_title(array("feature"=>"Paying User", "from"=>$dayArr[0], "game_info"=>$this->_gameInfo), $key);
					$viewdata['kpi'] = "Paying User";
					$viewdata['metric'] = "Paying User";
					$viewdata['unit'] = "user";
					$viewdata['data'] = $data;
			...
			<div class="col-md-6">
				...
				<?php 
					...
					$viewdata['subTitle'] = $this->util->get_sub_chart_title(array("feature"=>"Revenue", "from"=>$dayArr[1], "game_info"=>$this->_gameInfo), $key);
			...
			<div class="col-md-6">
				<div id="p_gr<?php echo $key ?>" class="chart-area"><i class="fa fa-spinner fa-spin fa-4x"></i></div>
				<?php 
					$total += 1;
					$data = $pie["group"][$key]["gr" . $kpiName];
					$dayArr = $pie["log_date"];
					...
					$viewdata["timing"] = $key;
					$viewdata["game"] = $game;
					$viewdata['id'] = "p_gr" . $key;
					$viewdata['title'] = $this->util->get_main_chart_title(array("feature"=>"Revenue","game_info"=>$this->_gameInfo), $key);
					$viewdata['subTitle'] = $this->util->get_sub_chart_title(array("feature"=>"Revenue", "from"=>$dayArr[0], "game_info"=>$this->_gameInfo), $key);
					$viewdata['kpi'] = "Revenue";
					$viewdata['metric'] = "Revenue";
					$viewdata['unit'] = "VND";
					$viewdata['data'] = $data;
		...
		<div class="tab-pane" id="tab_firstcharge<?php echo $key ?>">
			<div class="col-md-6">
				...
				<?php 
					$total += 1;
					$data = $pie["group"][$key]["npu" . $kpiName];
					$dayArr = $pie["log_date"];
					...
					$viewdata['subTitle'] = $this->util->get_sub_chart_title(array("feature"=>"Firstcharge User", "from"=>$dayArr[1], "game_info"=>$this->_gameInfo), $key);
			...
			<div class="col-md-6">
				<div id="p_firstcharge<?php echo $key ?>" class="chart-area"><i class="fa fa-spinner fa-spin fa-4x"></i></div>
				<?php 
					$total += 1;
					$data = $pie["group"][$key]["npu" . $kpiName];
					$dayArr = $pie["log_date"];
					...
					$viewdata["timing"] = $key;
					$viewdata["game"] = $game;
					$viewdata['id'] = "p_firstcharge" . $key;
					$viewdata['title'] = $this->util->get_main_chart_title(array("feature"=>"Firstcharge User","game_info"=>$this->_gameInfo), $key);
					$viewdata['subTitle'] = $this->util->get_sub_chart_title(array("feature"=>"Firstcharge User", "from"=>$dayArr[0], "game_info"=>$this->_gameInfo), $key);
					$viewdata['kpi'] = "Firstcharge User";
					$viewdata['metric'] = "Firstcharge User";
					$viewdata['unit'] = "user";
					$viewdata['data'] = $data;
			...
			<div class="col-md-6">
				...
				<?php 
					$total += 1;
					$data = $pie["group"][$key]["npu_gr" . $kpiName];
					$dayArr = $pie["log_date"];
					...
					$viewdata['subTitle'] = $this->util->get_sub_chart_title(array("feature"=>"Firstcharge Revenue", "from"=>$dayArr[1], "game_info"=>$this->_gameInfo), $key);
			...
			<div class="col-md-6">
				<div id="p_firstcharge_gr<?php echo $key ?>" class="chart-area"><i class="fa fa-spinner fa-spin fa-4x"></i></div>
				<?php 
					$total += 1;
					$data = $pie["group"][$key]["npu_gr" . $kpiName];
					$dayArr = $pie["log_date"];
					...
					$viewdata["timing"] = $key;
					$viewdata["game"] = $game;
					$viewdata['id'] = "p_firstcharge_gr" . $key;
					$viewdata['title'] = $this->util->get_main_chart_title(array("feature"=>"Firstcharge Revenue","game_info"=>$this->_gameInfo), $key);
					$viewdata['subTitle'] = $this->util->get_sub_chart_title(array("feature"=>"Firstcharge Revenue", "from"=>$dayArr[0], "game_info"=>$this->_gameInfo), $key);
					$viewdata['kpi'] = "Firstcharge Revenue";
					$viewdata['metric'] = "Firstcharge Revenue";
					$viewdata['unit'] = "VND";
					$viewdata['data'] = $data;

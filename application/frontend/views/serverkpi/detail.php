		...
		<div class="col-md-12">
			<div class="box box-solid">
				<div class="box-header with-border">
	                <h3 class="box-title"><i class="fa fa-th"></i> Server List</h3>
	            </div>
					...
					<div class="row">
						<form name="form" action="" method="post">
							...
							<div class="col-md-2 col-sm-4 col-xs-6">
					            <label title="SID: <?php echo $id?>"> <input type="checkbox" name="selectedServer[]" value="<?php echo $id ?>"
					            <?php if(array_key_exists($id, $selectedArr)){ echo 'checked';}?>> <?php if($id == "" || $name == "" ) {echo "NoName";} else { echo $name; }?></label>
							</div>
							<?php 
								}
							?>

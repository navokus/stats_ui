...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
        ...
        foreach ($lstdate as $date){
            ...
            if($i>0){
                if($countChannel[$i] > $countChannel[$i-1]){
     ...
     hoặc liên hệ <b>[canhtq@vng.com.vn or quangctn@vng.com.vn or lamnt6@vng.com.vn]</b> để được hỗ trợ. Cảm ơn.</p>";
                                                ...
                                                <table class="table table-striped table-bordered" id="kpi_table"
                                                    ...
                                                    <tr>
                                                        ...
                                                        foreach ($lstdate as $date) {
                                                            foreach ($channels as $channel) {
                                                                ?>
                                                                <th class="text-left"
                                                                    style="width: auto;"><?php echo $channel ?> </th>
                                                            <?php }
                                                        }?>
                                                    </tr>
                                                    ...
                                                    foreach ($kpiTable as $kpi => $desc) { ?>
                                                        <tr>
                                                            <td> <?php echo $desc ?> </td>
                                                            <?php foreach ($lstdate as $date) { ?>
                                                                <?php foreach ($channels as $channel) { ?>
                                                                    <td class="text-left"><?php

                                                                        if(isset($data[$date][$body['gameCode']][$channel][$kpi])){
                                                                            echo  number_format($data[$date][$body['gameCode']][$channel][$kpi]);
                                                                        }else{
                                                                            echo 0;
                                                                        }

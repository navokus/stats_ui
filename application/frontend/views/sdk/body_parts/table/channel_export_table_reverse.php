    ...
    <div class="col-md-12">
        <div class="box box-solid">
            ...
            <div class="box-body text-center first">
                <?php
                if(count($data['channel']) == 0 || (count($data['channel'])==1 && $data['channel'][0]==null)){
                        ...
                        foreach ($data as $key => $value) {
                            ...
                            if($key == 'log_date'){
                                ...
                                for($i = 0; $i < $count; $i++ ) {
                                    ...
                                    foreach ($data['channel'][$i] as $checkPac) {
                                        if (isset($checkPac)) {
                                            $flag = true;
                                        }
                                    }
                                ...
                                if($flag){
                                    ...
                                    <tr>
                                        <?php
                                        for($i = 0; $i < $count; $i++ ){
                                            foreach ($data['channel'][$i] as $channel) {
                                                if(isset($channel)){
                                                    ?>
                                                    <th class="text-center"><?php echo $channel ?></th>
                                                <?php }
                                                else{
                            ...
                            <?php }else{
                                if($key != 'channel'){ ?>
                                    <tr>
                                        <td class="text-left"><b><?php  echo $key ?></b></td>
                                        <?php
                                        for($i = 0; $i < $count; $i++ ){
                                            foreach($value[$i] as $k => $v){ ?>
                                                ...
                                                <td class="text-right"><?php
                                                    if(isset($v)){
                                                        echo $this->util->ud_format_number($v);
                                                    }else{
                                                        echo 0;
                                                    }
                                            ?></td>

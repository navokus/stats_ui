...
class Playing_detail_grade_model extends CI_Model {

	public $table = 'RC_Playtime_Detail_Grade';
	...
	public function getPlaytimeDetailGrade($gameCode, $times, $curDate)
	{
				
		$this->db->select('t1.*, t2.GradeName')
				->from($this->table . ' t1')
				->join('C_Grade t2','t1.IdGradePrevious = t2.IdGrade AND t2.GradeType = 2 AND t2.GameCode="' . $gameCode . '"', 'left')

...
class Groupkpi_model extends MY_Model {
    ...
    public function __construct()
    {
         ...
         * 
         */
        $this->tableInfo["mapping"] = array("name" => "Group", "tbl_gid" => "id", "tbl_gname" => "name", "tbl_name" => "group_name_conf", "dta_table" => "group_kpi_json", "dta_group_field" => "group_id", "dta_group" => "group_kpi");
    ...
    /**
     * Using to map group id in a game to a name
     * 
    ...
    public function getGroupList($groupId, $gameCode, $isFix = false){
    	...
    	// vinhdp - 2017-02-27
    	$groupConf = isset($groupConf) ? $groupConf : $this->tableInfo["mapping"];
    ...
    public function getGroupInfo($groupId) {
    	...
    	$sql = $groupConf["tbl_gname"];
    	$this->db->select($sql, false);
    	$this->db->from($groupConf["tbl_name"]);
    	$this->db->where('game_code', 'group');

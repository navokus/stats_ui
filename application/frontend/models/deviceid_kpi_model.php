...
class DeviceId_Kpi_model extends MY_Model
{

    private $_table_name = 'device_id_kpi';
    ...
    public function getUserKpiData($gameCode, $kpi_type, $timming, $from, $to)
    {
        ...
        /* $kpi_field_config = $db_field_config['user_kpi'][$timming];
        ...
        if($timming == '4'){
        	$kpi_field_config = array_merge($db_field_config['user_kpi']['4'],
        			$db_field_config['user_kpi']['5'],
        			$db_field_config['user_kpi']['6'],
        			$db_field_config['user_kpi']['3'],
        			$db_field_config['user_kpi']['14']);
        }else{
        	$kpi_field_config = array_merge($db_field_config['user_kpi'][$timming]);
        }
        $kpi_ids_config = $this->getKpiIDs($ubstats, $kpi_field_config);
